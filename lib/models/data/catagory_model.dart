...
const unsurAlkaliMetal = [
  CategoryItemGrid(
      id: 'a1',
      symbol: 'Li',
      title: 'Lithium',
      containerColor: ChemistryColorApp.containerMenu1,
...
ringan yang lunak, berwarna perak kebiruan. 
Unsur ini memiliki konduktivitas 
listrik dan panas yang baik,
 serta reaktivitas kimia yang tinggi. 
 Litium digunakan dalam 
 berbagai aplikasi, termasuk dalam 
 baterai ion litium yang 
 digunakan dalam perangkat elektronik, 
 dalam paduan logam 
 untuk pengecoran dan pembuatan logam, 
 serta dalam obat-obatan 
 psikiatri untuk pengobatan gangguan mental.
''',
  ),
  AlkaliData(
    id: 'z2',
...
''',
    description: '''
Natrium adalah logam alkali yang lunak, berwarna perak, 
dan sangat reaktif. Unsur ini ditemukan dalam berbagai 
senyawa seperti garam dapur (natrium klorida) dan
 digunakan dalam berbagai aplikasi, termasuk dalam
  industri kimia, industri logam, dan dalam proses 
  pemurnian logam. Natrium juga memiliki peran penting
   dalam menjaga keseimbangan air dan
